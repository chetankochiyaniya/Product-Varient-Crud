...
export default function VariantCategoryTable(props) {
    ...
    function setTableData(tableData) {
        ...
        tableData.map((obj, index) => {
            rowTableData.push(getRowForVariantCategoryTable(index, obj));
        });
        setTableDataFormatted(rowTableData);
    }

    function getRowForVariantCategoryTable(ind, obj) {
        return {
            index: ind + 1,
            name: obj.name,
            delete: (<Button
    ...
    const handleSearch = (e) => {
        ...
        setTableDataFormatted(filteredData.map((obj, index) => getRowForVariantCategoryTable(index, obj)));
    };
