...
export default function VariantProductTable(props) {
    ...
    function setTableData(tableData) {
        ...
        tableData.map((obj, index) => {
            rowTableData.push(getRowForVariantProductTable(index, obj));
        });
        setTableDataFormatted(rowTableData);
    }

    function formatVariantOptions(variantOptions) {
    ...
    function getRowForVariantProductTable(ind, obj) {
        return {
            index: ind + 1,
            category_name: obj.category_name,
            price: obj.price,
            variant: formatVariantOptions(obj.variant_options),
            delete: (<Button
                variant="danger"
                className="py-1 px-1"
                onClick={() =>
    ...
    const handleSearch = (e) => {
        ...
        setTableDataFormatted(filteredData.map((obj, index) => getRowForVariantProductTable(index, obj)));
    };
